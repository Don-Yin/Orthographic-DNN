...
def old_subloop(words_a, words_b, function=levenshtein_distance, n=20, n_jobs=-1):
...
def old_n(words, reference=None, n=20, function=levenshtein_distance, n_jobs=-1):
    """
    ...
    vals = old_subloop(words, reference, function, max(n), n_jobs)
